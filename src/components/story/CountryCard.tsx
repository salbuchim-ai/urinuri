...
export function CountryCard({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={`relative flex h-[92px] w-full overflow-hidden rounded-lg border bg-white text-left transition focus:outline-none focus:ring-4 focus:ring-blue-100 ${
        selected ? "border-amber-500 ring-2 ring-amber-400" : "border-slate-300 hover:border-blue-500"
      }`}
    >
      <Image
        src={`/generated/countries/${option.id}.png`}
      ...
      <span className="relative flex w-full items-end justify-end px-5 pb-3">
